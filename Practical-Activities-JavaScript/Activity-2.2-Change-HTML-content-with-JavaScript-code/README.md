...
11. Inside the function body, add some statements that will be executed when the function is called:
    * Use the `getElementById()` method to target the `id` of the HTML heading element inside your HTML file and store this expression in a variable name.
    * Use the `textContent` property of the heading element to assign new text to the HTML element.
...
This mini project allows students to start practicing changing HTML content with JavaScript.